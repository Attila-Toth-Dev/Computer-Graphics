...
//}
//
//void GraphicsApp::CreateBox(glm::vec3 _position, float _scale)
//{
...
//
//	vertices[4].position = { -0.5f, 1.5f,  0.5f, 1 };
//	vertices[5].position = { 0.5f, 1.5f,  0.5f, 1 };
//	vertices[6].position = { -0.5f, 1.5f, -0.5f, 1 };
//	vertices[7].position = { 0.5f, 1.5f, -0.5f, 1 };
//
...
//}
//
//void GraphicsApp::CreateCyclinder(float _radius, int _segments)
//{
//	Mesh::Vertex vertices[8];
//
...
//	{
//		vertices[0].position = {0, _radius / 2, 0, 1};
//		vertices[1].position = { sinf(i * segmentSize) * _radius, _radius / 2, cosf(i * segmentSize) * _radius, 1 };
//		vertices[2].position = { sinf((i + 1) * segmentSize) * _radius, _radius / 2, cosf((i + 1) * segmentSize) * _radius , 1 };
//	}
//}
//
//void GraphicsApp::CreateCircle(glm::vec2 _centre, float _radius, int _segments)
//{
